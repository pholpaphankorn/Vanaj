...
export function ChatWindow(props: {
  ...
  return (
    ...
    //flex flex-col items-center p-4 md:p-8 rounded grow mx-auto sm:max-w-4xl sm:px-4 p-4 md:p-12 h-[100vh]
    <div className={`flex flex-col items-center p-4 md:p-8 rounded grow mx-auto sm:max-w-5xl sm:px-4 p-4 md:p-12 h-[100vh]`}>
      <div
        className="flex flex-col-reverse w-full mb-8  transition-[flex-grow] ease-in-out "
        ...
        <div className="relative">
          ...
          >
            ...
            <svg
              ...
              className={`${(chatEndpointIsLoading) ? "hidden" : ""} h-6 w-6`}
              aria-hidden="true"
              viewBox="0 0 24 24"
              strokeWidth="2"
              stroke="currentColor"
